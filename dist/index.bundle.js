...
function findColor(day) {
  const result = _weatherConditions__WEBPACK_IMPORTED_MODULE_1__.weatherConditions.find(({ code }) => code === day);
  return result.color;
}
